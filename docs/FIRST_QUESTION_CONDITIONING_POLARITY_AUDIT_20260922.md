...
The theorem is listed in `Audit.lean`; exact-head CI must validate elaboration, full build/root coverage, forbidden-placeholder checks, and the zero-axiom kernel audit before this round is considered verified.
